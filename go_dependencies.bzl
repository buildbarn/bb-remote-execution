...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:S7FsIuYQP9bP9fZ71Oq+GXYTjvaoc/001plSQY10j5k=",
        version = "v1.21.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:lIB4FVkPa0+grey3qDUAyCGj8jJso9KSz11Gr3ws5HQ=",
        version = "v1.17.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:mMqATHfuWtgVPehBsJ8ZcrN8LD4xLXQAAbAvydbosW4=",
        version = "v0.0.0-20220228210157-444d20f4cbfd",
    )
    go_repository(
