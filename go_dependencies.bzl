...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:qLesC5+MqYoZW/OwW+5GW1/Mqyl8Agu+7rawXwZtG+s=",
        version = "v1.19.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:dzWS4r8E9bA0TesHM40FSAtedwpTVCuTsLI8EziSqyk=",
        version = "v1.16.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:KRjdTwspga6iJtOJ5ggznUSBqYjPjW3O3Bxjbpw6/7U=",
        version = "v0.0.0-20220211114844-e5ee29d82ea7",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:f+JfMSDNm2u+fekYYjyoixk+DWDTDAGD3SC50y61koE=",
        version = "v1.3.0",
    )
    go_repository(
