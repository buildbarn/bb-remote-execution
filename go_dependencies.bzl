...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:1Yl51M7ccPNDFxnw5HvdQ52F7qG035JRP/HbYvJBOCo=",
        version = "v1.15.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:t76IPhbZRQdnPBMPIg1IWI/rZyNuWsXMrRdvHkOCx0s=",
        version = "v1.12.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:WHOIVHYcxPJq9XYFn/Bfdpt1TpQjZdl4HeveekwlDls=",
        version = "v0.0.0-20211122093135-d8c9c70005eb",
    )
    go_repository(
