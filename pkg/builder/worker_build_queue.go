...
// workers.
func NewWorkerBuildQueue(deduplicationKeyFormat util.DigestKeyFormat, executionDigestFunction remoteexecution.DigestFunction, jobsPendingMax uint64) (builder.BuildQueue, scheduler.SchedulerServer) {
	bq := &workerBuildQueue{
