...
type RunResponse struct {
	...
	ResourceUsage []*any.Any `protobuf:"bytes,2,rep,name=resource_usage,json=resourceUsage,proto3" json:"resource_usage,omitempty"`
}
...
func (x *RunResponse) GetResourceUsage() []*any.Any {
	if x != nil {
...
func (c *runnerClient) CheckReadiness(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (*UnimplementedRunnerServer) CheckReadiness(context.Context, *empty.Empty) (*empty.Empty, error) {
...
func _Runner_CheckReadiness_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RunnerServer).CheckReadiness(ctx, req.(*empty.Empty))
	}
