...
func (x *WinFSPMountConfiguration) GetCaseSensitive() bool {
	if x != nil {
...
const file_pkg_proto_configuration_filesystem_virtual_virtual_proto_rawDesc = "" +
	"\n" +
	"8pkg/proto/configuration/filesystem/virtual/virtual.proto\x12*buildbarn.configuration.filesystem.virtual\x1a\x1egoogle/protobuf/duration.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a/pkg/proto/configuration/eviction/eviction.proto\x1a/pkg/proto/configuration/jmespath/jmespath.proto\"\xd5\x02\n" +
	...
	"\x18cache_replacement_policy\x18\x03 \x01(\x0e28.buildbarn.configuration.eviction.CacheReplacementPolicyR\x16cacheReplacementPolicy\"A\n" +
	"\x18WinFSPMountConfiguration\x12%\n" +
	"\x0ecase_sensitive\x18\x01 \x01(\bR\rcaseSensitiveBUZSgithub.com/buildbarn/bb-remote-execution/pkg/proto/configuration/filesystem/virtualb\x06proto3"
...
var file_pkg_proto_configuration_filesystem_virtual_virtual_proto_depIdxs = []int32{
	...
	8,  // 6: buildbarn.configuration.filesystem.virtual.FUSEMountConfiguration.linux_backing_dev_info_tunables:type_name -> buildbarn.configuration.filesystem.virtual.FUSEMountConfiguration.LinuxBackingDevInfoTunablesEntry
