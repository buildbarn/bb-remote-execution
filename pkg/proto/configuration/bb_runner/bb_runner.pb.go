...
type ApplicationConfiguration struct {
	...
	SampleCgroupResourceUsage      bool                                      `protobuf:"varint,15,opt,name=sample_cgroup_resource_usage,json=sampleCgroupResourceUsage,proto3" json:"sample_cgroup_resource_usage,omitempty"`
...
func (x *ApplicationConfiguration) GetSampleCgroupResourceUsage() bool {
	if x != nil {
		return x.SampleCgroupResourceUsage
	}
	return false
}
