...
type RootDirectory struct {
	...
	InitialCreationTime *timestamp.Timestamp `protobuf:"bytes,1,opt,name=initial_creation_time,json=initialCreationTime,proto3" json:"initial_creation_time,omitempty"`
...
func (x *RootDirectory) GetInitialCreationTime() *timestamp.Timestamp {
	if x != nil {
