...
const file_pkg_proto_tmp_installer_tmp_installer_proto_rawDesc = "" +
	"\n" +
	"+pkg/proto/tmp_installer/tmp_installer.proto\x12\x17buildbarn.tmp_installer\x1a\x1bgoogle/protobuf/empty.proto\"S\n" +
