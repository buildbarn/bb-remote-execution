...
func NewWinFSPFileSystem(rootDirectory virtual.Directory, caseSensitive bool) *WinfspFileSystem {
	return &WinfspFileSystem{
...
func (fs *WinfspFileSystem) Mount(mountpoint string) (*ffi.FileSystem, error) {
...
func toWinFSPFileInfo(attributes *virtual.Attributes, info *ffi.FSP_FSCTL_FILE_INFO) {
	...
	info.ChangeTime = ffi.Timestamp(filesystem.DeterministicFileModificationTimestamp)
	info.CreationTime = ffi.Timestamp(filesystem.DeterministicFileModificationTimestamp)
	info.LastAccessTime = ffi.Timestamp(filesystem.DeterministicFileModificationTimestamp)
...
func (fs *WinfspFileSystem) openOrCreateFileOrDir(ctx context.Context, parent virtual.Directory, leafName path.Component, disposition uint32, shareMask virtual.ShareMask, createPermissions virtual.Permissions, attributes *virtual.Attributes) (virtual.DirectoryChild, virtual.ShareMask, error) {
...
func (fs *WinfspFileSystem) createHandle(ctx context.Context, name string, createOptions, grantedAccess uint32, createPermissions virtual.Permissions, info *ffi.FSP_FSCTL_FILE_INFO) (uintptr, error) {
...
func parsePath(name string) (parentName string, leafName path.Component, err error) {
	...
	if lastSeparator < 0 {
		return "", path.Component{}, windows.STATUS_INVALID_PARAMETER
	}
...
var (
	_ ffi.BehaviourBase                  = (*WinfspFileSystem)(nil)
	_ ffi.BehaviourCanDelete             = (*WinfspFileSystem)(nil)
	_ ffi.BehaviourCleanup               = (*WinfspFileSystem)(nil)
	_ ffi.BehaviourCreate                = (*WinfspFileSystem)(nil)
	_ ffi.BehaviourDeleteReparsePoint    = (*WinfspFileSystem)(nil)
	_ ffi.BehaviourFlush                 = (*WinfspFileSystem)(nil)
	_ ffi.BehaviourGetDirInfoByName      = (*WinfspFileSystem)(nil)
	_ ffi.BehaviourGetFileInfo           = (*WinfspFileSystem)(nil)
	_ ffi.BehaviourGetReparsePoint       = (*WinfspFileSystem)(nil)
	_ ffi.BehaviourGetReparsePointByName = (*WinfspFileSystem)(nil)
	_ ffi.BehaviourGetSecurity           = (*WinfspFileSystem)(nil)
	_ ffi.BehaviourGetSecurityByName     = (*WinfspFileSystem)(nil)
	_ ffi.BehaviourGetVolumeInfo         = (*WinfspFileSystem)(nil)
	_ ffi.BehaviourOverwrite             = (*WinfspFileSystem)(nil)
	_ ffi.BehaviourRead                  = (*WinfspFileSystem)(nil)
	_ ffi.BehaviourReadDirectoryOffset   = (*WinfspFileSystem)(nil)
	_ ffi.BehaviourRename                = (*WinfspFileSystem)(nil)
	_ ffi.BehaviourSetBasicInfo          = (*WinfspFileSystem)(nil)
	_ ffi.BehaviourSetFileSize           = (*WinfspFileSystem)(nil)
	_ ffi.BehaviourSetReparsePoint       = (*WinfspFileSystem)(nil)
	_ ffi.BehaviourSetSecurity           = (*WinfspFileSystem)(nil)
	_ ffi.BehaviourSetVolumeLabel        = (*WinfspFileSystem)(nil)
	_ ffi.BehaviourWrite                 = (*WinfspFileSystem)(nil)
)
