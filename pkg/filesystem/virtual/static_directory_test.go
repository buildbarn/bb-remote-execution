...
func TestStaticDirectoryVirtualLookup(t *testing.T) {
	...
	d := virtual.NewStaticDirectory(true, map[path.Component]virtual.DirectoryChild{
...
func TestStaticDirectoryCaseInsensitive(t *testing.T) {
	...
	child := mock.NewMockVirtualDirectory(ctrl)
	d := virtual.NewStaticDirectory(false, map[path.Component]virtual.DirectoryChild{
		path.MustNewComponent("Child"): virtual.DirectoryChild{}.FromDirectory(child),
	})
