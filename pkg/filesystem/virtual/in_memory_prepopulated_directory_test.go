...
func TestInMemoryPrepopulatedDirectoryLookupChildNonExistent(t *testing.T) {
	...
	d := virtual.NewInMemoryPrepopulatedDirectory(fileAllocator, symlinkFactory, errorLogger, handleAllocator, sort.Sort, hiddenFilesPatternForTesting.MatchString, clock.SystemClock, true, defaultAttributesSetter.Call)
...
func TestInMemoryPrepopulatedDirectoryInstallHooks(t *testing.T) {
	...
	d := virtual.NewInMemoryPrepopulatedDirectory(fileAllocator1, symlinkFactory1, errorLogger1, handleAllocator, sort.Sort, hiddenFilesPatternForTesting.MatchString, clock.SystemClock, true, defaultAttributesSetter1.Call)
	...
	d.InstallHooks(fileAllocator2, errorLogger2, defaultAttributesSetter2.Call)
...
func TestInMemoryPrepopulatedDirectoryCaseInsensitive(t *testing.T) {
	...
	inMemoryPrepopulatedDirectoryExpectMkdir(ctrl, handleAllocator)
	defaultAttributesSetter := mock.NewMockDefaultAttributesSetter(ctrl)
	d := virtual.NewInMemoryPrepopulatedDirectory(fileAllocator, symlinkFactory, errorLogger, handleAllocator, sort.Sort, hiddenFilesPatternForTesting.MatchString, clock.SystemClock, false, defaultAttributesSetter.Call)
...
func TestInMemoryPrepopulatedDirectoryVirtualGetAttributes(t *testing.T) {
	...
	defaultAttributesSetter := mock.NewMockDefaultAttributesSetter(ctrl)
	d := virtual.NewInMemoryPrepopulatedDirectory(fileAllocator, symlinkFactory, errorLogger, handleAllocator, sort.Sort, hiddenFilesPatternForTesting.MatchString, clock, true, defaultAttributesSetter.Call)
	...
	defaultAttributesSetter.EXPECT().Call(inMemoryPrepopulatedDirectoryAttributesMask, gomock.Any()).
		Do(func(attributesMask virtual.AttributesMask, attributes *virtual.Attributes) {
			attributes.SetOwnerUserID(1000)
		})
...
func TestInMemoryPrepopulatedDirectoryVirtualRenameCrossDevice1(t *testing.T) {
	...
	inMemoryPrepopulatedDirectoryExpectMkdir(ctrl, handleAllocator)
	defaultAttributesSetter := mock.NewMockDefaultAttributesSetter(ctrl)
	d1 := virtual.NewInMemoryPrepopulatedDirectory(fileAllocator, symlinkFactory, errorLogger, handleAllocator, sort.Sort, hiddenFilesPatternForTesting.MatchString, clock.SystemClock, true, defaultAttributesSetter.Call)
...
func TestInMemoryPrepopulatedDirectoryVirtualRenameCrossDevice2(t *testing.T) {
	...
	defaultAttributesSetter1 := mock.NewMockDefaultAttributesSetter(ctrl)
	d1 := virtual.NewInMemoryPrepopulatedDirectory(fileAllocator1, symlinkFactory1, errorLogger1, handleAllocator1, sort.Sort, hiddenFilesPatternForTesting.MatchString, clock.SystemClock, true, defaultAttributesSetter1.Call)
	...
	defaultAttributesSetter2 := mock.NewMockDefaultAttributesSetter(ctrl)
	d2 := virtual.NewInMemoryPrepopulatedDirectory(fileAllocator2, symlinkFactory2, errorLogger2, handleAllocator2, sort.Sort, hiddenFilesPatternForTesting.MatchString, clock.SystemClock, true, defaultAttributesSetter2.Call)
