...
//
// This type is used by InMemoryPrepopulatedDirectory to make the policy
// for sorting the results of VirtualReadDir() configurable. Depending
// on the use case, it is desirable to use a deterministic algorithm
// (e.g., alphabetic sorting) or an undeterministic one (e.g., random
// shuffling).
